...
| [Elaborador de Resumos Acadêmicos e Simulados de Prova](05_Curadoria_Social_Midia_e_Estudos/Elaborador%20de%20Resumos%20Acadêmicos%20e%20Simulados%20de%20Prova.md) | `Gemini 3.8 Flash` | Par de prompts operacionais desenvolvidos para criar materiais de estudo estruturados por aula e gerar simulações de provas teóricas estrita... |
| [Guia de Instalação e Parametrização de Skills](05_Curadoria_Social_Midia_e_Estudos/Guia%20de%20Instalação%20e%20Parametrização%20de%20Skills.md) | `Gemini 3.8 Flash` | Guia prático para invocar, instalar e parametrizar Skills externas no Claude, transformando-o em um agente com habilidades especializadas de... |
...
| [Prototipador de UI e Design System no Terminal (Comando Design)](05_Curadoria_Social_Midia_e_Estudos/Prototipador%20de%20UI%20e%20Design%20System%20no%20Terminal%20(Comando%20Design).md) | `Claude Sonnet 5` | Template de especificação visual para ser executado no comando `/design` do Claude Code, permitindo gerar interfaces e mockups interativos d... |
...
| [Sistema NEXUS - Gerador de Prompts Cinematográficos de Imagem](05_Curadoria_Social_Midia_e_Estudos/Sistema%20NEXUS%20-%20Gerador%20de%20Prompts%20Cinematográficos%20de%20Imagem.md) | `Nano Banana Pro` | Sistema avançado para arquitetar prompts cinematográficos e de alta fidelidade para Midjourney v6.1, Flux.1 e Nano Banana Pro, controlando i... |
